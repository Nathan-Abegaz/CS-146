...
public class DivideConquerJUnits {
	...
	public void test() {
		...
		DivideConquer dq = new DivideConquer();
		...
		assertEquals(239,dq.findMaxSubArray(input1, 0, input1.length-1));
		//assertEquals(77,dq.arrive);
		//assertEquals(97,dq.depart);
		
		assertEquals(322,dq.findMaxSubArray(input2, 0, input2.length-1));
		assertEquals(50,dq.arrive);
		//assertEquals(99,dq.depart);
		
		assertEquals(305,dq.findMaxSubArray(input3, 0, input3.length-1));
		//assertEquals(77,dq.arrive);
		//assertEquals(97,dq.depart);
		
		assertEquals(271,dq.findMaxSubArray(input4, 0, input4.length-1));
		//assertEquals(60,dq.arrive);
		assertEquals(98,dq.depart);
		
		assertEquals(281,dq.findMaxSubArray(input5, 0, input5.length-1));
//		assertEquals(54,dq.arrive);
		assertEquals(77,dq.depart);
	}
