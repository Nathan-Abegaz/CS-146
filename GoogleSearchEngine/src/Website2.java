...
public class Website2 {
	...
	public Website2(int index, int pageRank, int age, int connections, int subscription, int totalScore, int pageRank2, String url){
		this.index = index;
 ...
 */
	public static void swap(Website2[] A, int a, int b) {
		Website2 temp = A[a];
		A[a] = A[b];
		A[b] = temp;
	}
 ...
 */
	public static void maxHeapify(Website2[] heap, int i) 
	{
...
//	 * @param i the index at which to begin the max heapify method
//	 */
//		public static void maxHeapify(ArrayList<Website> heap, int i, int lastInt) 
//		{
//			int largest = 0; // Variable used to store a the object that has the biggest vales amongst 
//							 // the parent and child
//			int l = getLeft(i);
...
//			// If the parent is less than the child the child would be stored in the 
//			// largest variable. If not, the largest would still be the parent
//			if (lastInt <= heap.size() -1 && (heap.get(l)).getKey() > heap.get(i).getKey())
//			{
//				largest = l;
//			} 
//			else
...
//			
//			//If the parent is less than the right child, the right right child would be stored into the largest variable
//			if(lastInt < heap.size() -1 && heap.get(r).getKey() > heap.get(i).getKey())
//			{
//				largest = r; 
//			}
//			
 ...
 */
	...
	public static void buildMaxHeap(Website2[] heap)
	{ 
 ...
 */
	...
	public static void heapSort(Website2 [] heap)
	{
		buildMaxHeap(heap);
 ...
 * @param heap arraylist of website objects
 * @return the root
 */
	public static Website2 extractMax(Website2[] heap)
	{
		if(heap.length < 0)
		{
...
/*
 * Didn't understand how to to implement this meth
 */
	
	public void increaseKey(ArrayList<Website2> heap, int i, int key)
	{
	
	}
	
	public Website2 heapMaximum(ArrayList<Website2> heap)
	{
		return heap.get(0);
	}
